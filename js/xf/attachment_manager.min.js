...
console.error("No flow uploader support")}else console.error("flow.js must be loaded")},setupFlow:function(){var b=this.getFlowOptions(),a=new Flow(b),c=this;if(!a.support)return null;a.on("fileAdded",XF.proxy(this,"fileAdded"));a.on("filesSubmitted",function(){c.setUploading(!0);a.upload()});a.on("fileProgress",XF.proxy(this,"uploadProgress"));a.on("fileSuccess",XF.proxy(this,"uploadSuccess"));a.on("fileError",XF.proxy(this,"uploadError"));return a},getFlowOptions:function(){return{target:this.manageUrl,
allowDuplicateUploads:!0,fileParameterName:"upload",query:XF.proxy(this,"uploadQueryParams"),simultaneousUploads:1,testChunks:!1,progressCallbacksInterval:100,chunkSize:4294967296,readFileFn:function(b,a,c,d,e){var f="slice";b.file.slice?f="slice":b.file.mozSlice?f="mozSlice":b.file.webkitSlice&&(f="webkitSlice");d||(d="");e.readFinished(b.file[f](a,c,d))}}},setupUploadButtons:function(b,a){var c=this;b.each(function(){var d=g(this),e=d.data("accept")||"",f=g('<span class="js-attachButton" />').insertAfter(d).append(d);
"."==e&&(e="");d.click(function(n){n.preventDefault()});a.assignBrowse(f[0],!1,!1,{accept:e});if(null===c.supportsVideoAudioUploads){d=XF.config.allowedVideoExtensions;var h=XF.config.allowedAudioExtensions;e=e.split(",");for(var k in e){var l=e[k].substr(1);if(-1!==d.indexOf(l)||-1!==h.indexOf(l)){c.supportsVideoAudioUploads=!0;break}}}f=f.find("input[type=file]");f.attr("title",XF.htmlspecialchars(XF.phrase("attach")));f.css("overflow","hidden");f.css(XF.isRtl()?"right":"left",-1E3)})},fileAdded:function(b){var a=
this.applyUploadTemplate({filename:b.name,uploading:!0});this.resizeProgress(a,0);a.data("file",b);this.legacyMode?this.$filesContainer.addClass("is-active"):this.$container.addClass("is-active");a.appendTo(this.$filesContainer);this.fileMap[b.uniqueIdentifier]=a;var c=this.$filesContainer.closest('[data-xf-init="h-scroller"]');if(c.length&&(c=XF.Element.getHandler(c,"h-scroller"))){var d=Date.now();this.lastScroll<d-500&&(this.lastScroll=d,c.scrollTo(a.position().left-50))}this.$target.find(this.options.uploadButton).blur();
a=this.$target.find(this.options.uploadButton).first().data("video-size");if(this.options.checkVideoSize&&this.supportsVideoAudioUploads&&this.isVideoOrAudio(b)&&0<a&&b.size>a)return this.uploadError(b,this.addErrorToJson({},XF.phrase("file_too_large_to_upload"))),!1;if(0<XF.config.uploadMaxFilesize&&b.size>XF.config.uploadMaxFilesize)return this.uploadError(b,this.addErrorToJson({},XF.phrase("uploaded_file_is_too_large_for_server_to_process"))),!1},isVideoOrAudio:function(b){var a=b.name.split(".");
b=XF.config.allowedVideoExtensions;var c=XF.config.allowedAudioExtensions;if(1===a.length||""===a[0]&&a.length)return!1;a=a.pop();return-1!==b.indexOf(a)||-1!==c.indexOf(a)},uploadProgress:function(b){var a=this.fileMap[b.uniqueIdentifier];a&&(this.setUploading(!0),this.resizeProgress(a,b.progress()))},resizeProgress:function(b,a){a=Math.floor(100*a);b=b.find(this.options.templateProgress);var c=b.find("i");c.length||(c=g("<i />"),b.html("&nbsp;").append(c));c.text(a+"%").css("width",a+"%")},uploadSuccess:function(b,
a,c){a=this.getObjectFromMessage(a);this.setUploading(!1);a.status&&"error"==a.status?this.uploadError(b,a,c):a.attachment?this.insertUploadedRow(a.attachment,this.fileMap[b.uniqueIdentifier]):(a=this.addErrorToJson(a),this.uploadError(b,a,c))},setUploading:function(b){b=b?!0:!1;b!==this.isUploading&&((this.isUploading=b)?this.$target.trigger("attachment-manager:upload-start"):this.$target.trigger("attachment-manager:upload-end"))},getObjectFromMessage:function(b){if(b instanceof Object)return b;
try{return g.parseJSON(b)}catch(a){return this.addErrorToJson({})}},addErrorToJson:function(b,a){b.status="error";b.errors=[null===a?XF.phrase("oops_we_ran_into_some_problems"):a];return b},insertUploadedRow:function(b,a){b=this.applyUploadTemplate(b);this.editor||this.removeInsertButtons(b);a?a.replaceWith(b):(this.legacyMode?this.$filesContainer.addClass("is-active"):this.$container.addClass("is-active"),b.appendTo(this.$filesContainer));XF.activate(b);XF.layoutChange();a=g.Event("attachment:row-inserted");
